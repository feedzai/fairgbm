...
is generated automatically from comments in `config file <https://github.com/feedzai/fairgbm/blob/master/include/LightGBM/config.h>`__
by `this script <https://github.com/feedzai/fairgbm/blob/master/helpers/parameter_generator.py>`__.
