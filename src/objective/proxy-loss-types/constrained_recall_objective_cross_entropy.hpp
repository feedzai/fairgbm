...
namespace LightGBM {
    ...
    class ConstrainedRecallObjectiveCrossEntropy : public ConstrainedRecallObjective {
    public:
        
        explicit ConstrainedRecallObjectiveCrossEntropy(const Config &config): ConstrainedRecallObjective(config) {}
