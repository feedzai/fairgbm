...
namespace LightGBM {
    ...
    class ConstrainedRecallObjectiveQuadratic : public ConstrainedRecallObjective {
    public:
        
        explicit ConstrainedRecallObjectiveQuadratic(const Config &config): ConstrainedRecallObjective(config) {}
